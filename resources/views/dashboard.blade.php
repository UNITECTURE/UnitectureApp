            ...
            <div class="container mx-auto px-6 py-8">
                <div class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div class="bg-white rounded-2xl shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)] border border-slate-50 p-8 flex flex-col items-center text-center hover:shadow-[0_8px_30px_-4px_rgba(0,0,0,0.05)] transition-shadow duration-300">
                            <div class="w-16 h-16 rounded-2xl bg-[#eff6ff] text-[#3b82f6] flex items-center justify-center mb-6">
                            ...
                            <p class="text-sm text-slate-500 mb-8 max-w-[220px] leading-relaxed font-medium">Clear view of performance anytime.</p>
                        ...
                        <div class="bg-white rounded-2xl shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)] border border-slate-50 p-8 flex flex-col items-center text-center hover:shadow-[0_8px_30px_-4px_rgba(0,0,0,0.05)] transition-shadow duration-300">
                            ...
                            @php
                                $attendanceRoute = '#';
                                if(Auth::user()->isAdmin()) $attendanceRoute = route('admin.attendance.all');
                                elseif(Auth::user()->isSupervisor()) $attendanceRoute = route('supervisor.attendance.team');
                                else $attendanceRoute = route('employee.attendance');
                            @endphp
                            <a href="{{ $attendanceRoute }}" class="w-full py-3 px-4 bg-[#2563EB] hover:bg-blue-700 text-white text-sm font-bold rounded-lg transition-all shadow-sm shadow-blue-200 block">
                                Open
                            </a>
                        </div>
                        ...
                        <div class="bg-white rounded-2xl shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)] border border-slate-50 p-8 flex flex-col items-center text-center hover:shadow-[0_8px_30px_-4px_rgba(0,0,0,0.05)] transition-shadow duration-300">
                            <div class="w-16 h-16 rounded-2xl bg-[#ffedd5] text-[#f97316] flex items-center justify-center mb-6">
                            ...
                            <p class="text-sm text-slate-500 mb-8 max-w-[220px] leading-relaxed font-medium">Manage your team members and groups.</p>
                            <button class="w-full py-3 px-4 bg-[#2563EB] hover:bg-blue-700 text-white text-sm font-bold rounded-lg transition-all shadow-sm shadow-blue-200">
                                Open
                            </button>
                        </div>
                        ...
                        <div class="bg-white rounded-2xl shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)] border border-slate-50 p-8 flex flex-col items-center text-center hover:shadow-[0_8px_30px_-4px_rgba(0,0,0,0.05)] transition-shadow duration-300">
                            ...
                            <a href="{{ route('users.create') }}" class="w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold rounded-lg transition-all shadow-sm shadow-indigo-200 text-center block">
                                Add New User
                            </a>
                            @else
                            <button class="w-full py-3 px-4 bg-[#2563EB] hover:bg-blue-700 text-white text-sm font-bold rounded-lg transition-all shadow-sm shadow-blue-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-8">
                        <div class="bg-white rounded-2xl shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)] border border-slate-50 p-6 flex flex-col justify-between h-32 hover:shadow-[0_8px_30px_-4px_rgba(0,0,0,0.05)] transition-shadow duration-300">
