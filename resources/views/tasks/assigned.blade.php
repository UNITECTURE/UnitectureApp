                            ...
                            <div class="flex-1 min-w-[280px] sm:min-w-[20rem] flex flex-col h-full bg-slate-50 rounded-lg sm:rounded-xl border border-slate-200 max-h-full">
                                ...
                                <div class="p-3 sm:p-4 border-b border-slate-200 flex items-center justify-between shrink-0 bg-white rounded-t-lg sm:rounded-t-xl">
                                    <div class="flex items-center gap-1.5 sm:gap-2 min-w-0">
                                        ...
                                        <span class="bg-slate-200 text-slate-600 px-1.5 sm:px-2 py-0.5 rounded text-[10px] sm:text-xs font-bold shrink-0"
                                            x-text="tasksByStage(stage).length"></span>
                                    </div>
                                </div>

                                <!-- Cards Container -->
                                <div class="flex-1 overflow-y-auto p-2 sm:p-3 space-y-2 sm:space-y-3 custom-scrollbar" style="min-height: 100px;">
                            ...
                            <table class="w-full text-xs sm:text-sm min-w-[800px]">
                                <thead>
                                    <tr class="border-b border-slate-200 bg-slate-50">
                                        <th class="px-3 sm:px-4 md:px-6 py-2 sm:py-3 text-left font-bold text-slate-700 whitespace-nowrap">Sr No</th>
                                        <th class="px-3 sm:px-4 md:px-6 py-2 sm:py-3 text-left font-bold text-slate-700 whitespace-nowrap">Project Code</th>
                                        <th class="px-3 sm:px-4 md:px-6 py-2 sm:py-3 text-left font-bold text-slate-700 whitespace-nowrap">Task</th>
                                        <th class="px-3 sm:px-4 md:px-6 py-2 sm:py-3 text-left font-bold text-slate-700 whitespace-nowrap">Status</th>
                                        <th class="px-3 sm:px-4 md:px-6 py-2 sm:py-3 text-left font-bold text-slate-700 whitespace-nowrap">Stage</th>
                                        <th class="px-3 sm:px-4 md:px-6 py-2 sm:py-3 text-left font-bold text-slate-700 whitespace-nowrap">Assigned To</th>
                                        <th class="px-3 sm:px-4 md:px-6 py-2 sm:py-3 text-left font-bold text-slate-700 whitespace-nowrap">Start Date</th>
                                        <th class="px-3 sm:px-4 md:px-6 py-2 sm:py-3 text-left font-bold text-slate-700 whitespace-nowrap">End Date</th>
                                        <th class="px-3 sm:px-4 md:px-6 py-2 sm:py-3 text-left font-bold text-slate-700 whitespace-nowrap">Priority</th>
                                    </tr>
                                </thead>
                                <tbody>
            ...
            <div x-show="selectedTask"
                ...
                <div class="bg-white rounded-xl sm:rounded-2xl shadow-2xl w-full max-w-xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto"
                    ...
                    <template x-if="selectedTask">
                        ...
                        <template x-if="canEditDue">
                            <div x-show="showAddPeopleModal" x-transition class="fixed inset-0 z-[99998] flex items-center justify-center p-4 bg-black/50"
                        ...
                        <template x-if="canEditDue">
                            <div x-show="showTagModal" x-transition class="fixed inset-0 z-[99998] flex items-center justify-center p-4 bg-black/50"
