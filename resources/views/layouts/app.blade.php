...
<body class="font-sans antialiased text-slate-800 bg-[#F8F9FB]">
    <div id="app" class="relative">
        ...
        @if ($errors->any())
            <div id="error-alert"
                class="fixed top-0 left-0 right-0 z-50 w-full animate-in slide-in-from-top-2 duration-300">
                <div class="w-full px-4 sm:px-6 py-4 sm:py-5 shadow-xl bg-gradient-to-r from-red-500 to-red-600">
                    <div class="max-w-7xl mx-auto flex items-start justify-between gap-4">
                        ...
                        <button type="button" class="text-white hover:text-white/80 text-3xl font-bold flex-shrink-0 p-2"
            ...
            <div id="error-alert-session"
                ...
                <div class="w-full px-4 sm:px-6 py-4 sm:py-5 shadow-xl bg-gradient-to-r from-red-500 to-red-600">
                    <div class="max-w-7xl mx-auto flex items-center justify-between gap-4">
                        ...
                        <button type="button" class="text-white hover:text-white/80 text-3xl font-bold p-2"
