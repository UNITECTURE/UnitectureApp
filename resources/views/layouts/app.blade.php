...
<body class="font-sans antialiased text-slate-800 bg-[#F8F9FB]">
    ...
    <div x-data="{ show: true }" 
            ...
            class="fixed bottom-6 right-6 z-[150] bg-green-50 text-green-900 px-6 py-4 rounded-xl border border-green-200 shadow-2xl flex items-center gap-4 border-l-4 border-l-green-500">
    ...
    <div x-data="{ show: true }" 
            ...
            x-transition:leave-start="opacity-100 translate-y-0"
            x-transition:leave-end="opacity-0 translate-y-8"
            class="fixed bottom-6 right-6 z-[150] bg-red-50 text-red-900 px-6 py-4 rounded-xl border border-red-200 shadow-2xl flex items-center gap-4 border-l-4 border-l-red-500">
