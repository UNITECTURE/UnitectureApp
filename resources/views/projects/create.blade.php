                    ...
                    <div class="max-w-3xl mx-auto">
                        <form action="{{ route('projects.store') }}" method="POST"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                <!-- Project Code -->
                                <div>
                                    <label for="project_code" class="block text-sm font-bold text-slate-700 mb-2">Project
                                        Code</label>
                                ...
                                <div class="md:col-span-2">
                                    <label for="name" class="block text-sm font-bold text-slate-700 mb-2">Project
                                        Name</label>
                                ...
                                <!-- End Date -->
                                <div>
                                    <label for="end_date" class="block text-sm font-bold text-slate-700 mb-2">End Date
                                        (Optional)</label>
