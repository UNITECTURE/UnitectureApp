                ...
                <div class="container mx-auto px-6 py-8">
                    ...
                    <div class="max-w-4xl mx-auto space-y-6">
                        ...
                        @if(Auth::user()->isAdmin())
                            <!-- Admin Settings -->
                            <div
                                class="bg-white rounded-2xl shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)] border border-slate-50 p-6 mb-6">
                                <h3 class="text-lg font-bold text-slate-800 mb-4 flex items-center gap-2">
                                    <svg class="w-5 h-5 text-indigo-500" fill="none" stroke="currentColor" stroke-width="2"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <a href="{{ route('holidays.index') }}"
                                        class="group flex items-center justify-between p-4 rounded-xl border border-slate-100 hover:border-indigo-100 hover:bg-indigo-50/50 transition-all duration-200">
                                        <div>
                                            <h4 class="font-bold text-slate-700 group-hover:text-indigo-700">Manage Holidays
                                            </h4>
                                    ...
                                    <a href="{{ route('teams.index') }}"
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-400 mt-1">View teams, supervisors, members; assign
                                                secondary supervisor</p>
                                        </div>
                                        <div
                                            class="w-8 h-8 rounded-full bg-slate-50 text-slate-400 flex items-center justify-center group-hover:bg-indigo-500 group-hover:text-white transition-all">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2"
                                    ...
                                    <a href="{{ route('users.manage') }}"
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-400 mt-1">View all users, primary/secondary supervisor,
                                                delete</p>
                                        </div>
                                        <div
                                            class="w-8 h-8 rounded-full bg-slate-50 text-slate-400 flex items-center justify-center group-hover:bg-indigo-500 group-hover:text-white transition-all">
            ...
            <form action="{{ route('settings.updatePassword') }}" method="POST" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="email" value="{{ Auth::user()->email }}" disabled
                        class="w-full px-4 py-2.5 rounded-lg border border-slate-300 bg-slate-50 text-slate-600 cursor-not-allowed">
                </div>
                ...
                <div>
                    ...
                    <input type="password" id="new_password" name="new_password" required
                        class="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-red-500 focus:border-transparent"
                ...
                {{-- Confirm Password --}}
                <div>
                    <label for="new_password_confirmation" class="text-sm font-semibold text-slate-700 block mb-2">Confirm
                        Password</label>
                ...
                <div class="flex gap-3 pt-4 border-t border-slate-200">
                    <button type="submit"
                        class="w-full px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-colors">
                        Update Password
                    </button>
                </div>
            </form>
