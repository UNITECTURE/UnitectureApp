                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-slate-800">
                            {{ $role === 'admin' ? 'Attendance' : 'My Attendance' }}</h1>
                            ...
                            <div class="p-6 pb-24 flex flex-col flex-1 min-h-0">
                                ...
                                <form action="" method="GET" id="daily-date-form">
                                    <div class="relative mb-6" x-data="{ 
                                        ...
                                        <div x-ref="pickerTrigger"
                                            class="relative flex items-center w-full sm:w-auto border border-slate-200 rounded-lg px-4 py-2.5 bg-slate-50/50 cursor-pointer hover:bg-slate-100 transition-colors">
                                            <svg class="h-5 w-5 text-slate-500 mr-3 shrink-0" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z">
                                                </path>
                                            </svg>
                                            <span class="text-slate-700 font-medium text-sm whitespace-nowrap">Date: <span
                                                    class="text-slate-900" x-text="formattedDate"></span></span>
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="5" class="px-4 py-4 text-center text-sm text-slate-500">
                                                        {{ 'No records found for this date.' }}</td>
                                                </tr>
                                            @endforelse

                                            {{-- Spacer Rows only if we have records to maintain height consistency if
                                            desired --}}
                            ...
                            <div class="p-6 pb-24 flex flex-col flex-1 min-h-0">
                                ...
                                <form action="" method="GET" id="cumulative-filter-form" class="mb-6 flex gap-2">
                                    ...
                                    <div class="relative w-32">
                                        <select name="month"
                                            onchange="document.getElementById('cumulative-filter-form').submit()"
                                ...
                                <div class="flex gap-4 mb-8 overflow-x-auto pb-2">
                                    ...
                                    <div
                                        class="flex-1 min-w-[120px] bg-purple-50 rounded-lg p-3 text-center border border-slate-200 shadow-sm flex flex-col justify-center h-24">
                                        <div class="text-xl font-bold text-slate-800">{{ $cumulative_summary['holidays'] }}
                                        </div>
                                        <div class="text-[10px] uppercase font-bold text-slate-600 mt-1 leading-tight">
                                            Holidays<br>(INCL Sundays)</div>
                                    </div>
                                </div>
